/* @ts-self-types="./rustflow_wasm.d.ts" */
 ...
 * @returns {bigint}
 */
export function sum_of_squares(n) {
  const ret = wasm.sum_of_squares(n);
  return BigInt.asUintN(64, ret);
}
...
async function __wbg_init(module_or_path) {
  ...
  if (module_or_path === undefined) {
    module_or_path = "/wasm/rustflow_wasm_bg.wasm";
  }
  const imports = __wbg_get_imports();
